...
from visionts import ResidualDiffusion
...
class Model(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.vm = ResidualDiffusion(arch=config.vm_arch, finetune_type=config.ft_type, load_ckpt=config.vm_pretrained == 1, ckpt_dir=config.vm_ckpt)
